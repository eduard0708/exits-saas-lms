...
export class RoleEditorComponent implements OnInit {
  ...
  // Collector Operations (Combined: Grace Extensions + Cash Operations)
  { resource: 'money-loan:collector', displayName: '💵 Collector: Operations', description: 'Collector operations: cash float, grace extensions, field operations', actions: ['operate', 'grace-extension'], category: 'tenant', product: 'money-loan' },
