...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, IonButton, IonBadge, HeaderUtilsComponent, LucideAngularModule],
  template: `
    <div class="fixed-top-bar">
      <div class="top-bar-content">
        <div class="top-bar-left">
          <ion-button fill="clear" class="icon-button" size="small" (click)="openMenu()">
            <lucide-icon slot="icon-only" name="menu" class="w-5 h-5"></lucide-icon>
          </ion-button>
        ...
        <div class="top-bar-right">
          ...
          <ion-button fill="clear" class="icon-button" size="small" [routerLink]="notificationsLink">
            <lucide-icon slot="icon-only" name="bell" class="w-5 h-5"></lucide-icon>
          ...
          <ion-button
            *ngIf="showLogout"
            ...
            (click)="logout()"
          >
            <lucide-icon slot="icon-only" name="log-out" class="w-5 h-5"></lucide-icon>
          </ion-button>
        </div>
      </div>
    </div>
