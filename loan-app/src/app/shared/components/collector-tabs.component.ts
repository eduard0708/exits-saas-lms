...
@Component({
  ...
  template: `
    <ion-tab-bar class="bottom-tabs">
      ...
      >
        <lucide-icon name="grid" class="tab-icon"></lucide-icon>
      ...
      <ion-tab-button 
        ...
        [routerLinkActiveOptions]="{exact: false}"
      >
        <lucide-icon name="map" class="tab-icon"></lucide-icon>
      ...
      <ion-tab-button 
        ...
        [routerLinkActiveOptions]="{exact: false}"
      >
        <lucide-icon name="file-text" class="tab-icon"></lucide-icon>
      ...
      <ion-tab-button 
        ...
        [routerLinkActiveOptions]="{exact: false}"
      >
        <lucide-icon name="dollar-sign" class="tab-icon"></lucide-icon>
      ...
      <ion-tab-button 
        ...
        [routerLinkActiveOptions]="{exact: false}"
      >
        <lucide-icon name="alert-triangle" class="tab-icon"></lucide-icon>
