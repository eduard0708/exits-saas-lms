/**
 * Ensure money_loan_cash_overrides exists.
 *
 * This is a safety migration for environments where the original migration was
 * marked as applied but the table is missing.
 */
...
exports.down = async function down(knex) {
  // No-op: this migration is a safety net. Avoid dropping the table on rollback.
};
